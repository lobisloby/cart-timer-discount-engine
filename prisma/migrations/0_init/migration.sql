...
-- CreateTable
CREATE TABLE "ct_timer_sessions" (
    "id" TEXT NOT NULL,
    "shop" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "ct_campaigns_shop_key" ON "ct_campaigns"("shop");

-- CreateIndex
CREATE INDEX "ct_timer_sessions_shop_idx" ON "ct_timer_sessions"("shop");

-- CreateIndex
CREATE INDEX "ct_timer_sessions_expiresAt_idx" ON "ct_timer_sessions"("expiresAt");

-- CreateIndex
CREATE UNIQUE INDEX "ct_timer_sessions_shop_visitorId_key" ON "ct_timer_sessions"("shop", "visitorId");

-- CreateIndex
CREATE UNIQUE INDEX "ct_shops_shop_key" ON "ct_shops"("shop");
